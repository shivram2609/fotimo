...
<div class="navbar navbar-inverse navbar-fixed-top headroom" >
	<div class="container">
		...
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav pull-right">
				<li><a href="javascript:void(0);" title="How it Works">How it Works</a></li>
				<li><a href="<?php echo SITE_LINK."dashboard"; ?>" title=""> <?php //echo $this->Session->read("AuthUser.UserDetail.first_name"); ?> <?php echo "Hello  ". $this->Session->read("AuthUser.UserDetail.first_name"); //echo $userInfo['UserDetail']['first_name']; ?> </a>
				</li>
