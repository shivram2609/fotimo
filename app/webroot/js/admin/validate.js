$(document).ready(function() {	
  ...
  $(document).on('click', '.chk', function () {
	...
	$("#CategoryAdminIndexForm,#UserAdminIndexForm,#LocationAdminIndexForm,#CuisineAdminIndexForm").submit(function(){  if(searchButton == ''){ return validatemultipleaction(); }else{ $(".chk").removeAttr("checked"); return true; } });
	/* end here */
