...
<html lang="en">
    <head>
        ...
        <title><?php echo "Fotimo"; ?></title>
	</head>
    <body>
        <div style="width:700px; margin:auto; font-family:arial; font-size:15px; color:#333333; line-height:18px; background-color:#fc9b12;">
			<a href="<?php echo SITE_LINK; ?>" ><img src="<?php echo SITE_LINK; ?>img/logo.png" alt="<?php echo "Fotimo"; ?>" title="<?php echo "Fotimo"; ?>" border="0" style="margin:10px;"></a>
			...
			<div style="margin:auto; padding:15px; border:1px solid #ccc; border-top:none;"><br>
				...
				<a href="<?php echo SITE_LINK; ?>" style="color:#1B9ED5; text-decoration:none;" >Team <?php echo "Fotimo"; ?></a>.</p><br>
			</div>
			<div style="margin:auto; padding:10px; margin:0px; text-align:center; font-family:arial; font-size:12px; color:#333333; line-height:18px;" >
				All content &copy; <?php echo date("Y"); ?> by <?php echo "Fotimo"; ?>. All rights reserved.
			</div>
		</div>
	</body>
</html>
